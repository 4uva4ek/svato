...
if ($opt == 'add_cat' || $opt == 'edit_cat'){
    ...
    <input type="hidden" name="csrf_token" value="<?php echo cmsUser::getCsrfToken(); ?>" />
        <table width="600" border="0" cellspacing="5" class="proptable">
            <tr>
                <td width="211" valign="top"><?php echo $_LANG['AD_CATEGORY_NAME']; ?>: </td>
            ...
            <tr>
                <td valign="top"><?php echo $_LANG['AD_CATEGORY_POST']; ?>?</td>
                <td valign="top">
            ...
            <tr>
                <td valign="top"><?php echo $_LANG['AD_SERIAL_NUMBER']; ?>: </td>
