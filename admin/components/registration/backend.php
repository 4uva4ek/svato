...
if ($opt=='saveconfig'){
    ...
    $cfg['greetmsg_ato']        = cmsCore::request('greetmsg_ato', 'html', '');
    $cfg['greetmsg_title']        = cmsCore::request('greetmsg_title', 'html', '');
...
<div id="config_tabs" style="margin-top:12px;" class="uitabs">
    ...
    <ul id="tabs">
		...
		<li><a href="#armedlist"><span>Список збройних формувань</span></a></li>
    </ul>
            ...
            <tr>
                ...
                <td>
                    <select name="first_auth_redirect" id="first_auth_redirect" style="width:300px">
                        ...
                        <option value="clubs" <?php if ($cfg['first_auth_redirect']=='clubs') {echo 'selected';} ?>><?php echo $_LANG['AD_OPEN_PROFILE_CLUBS']; ?></option>
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <select name="auth_redirect" id="auth_redirect" style="width:300px">
                        ...
                        <option value="clubs" <?php if ($cfg['auth_redirect']=='clubs') {echo 'selected';} ?>><?php echo $_LANG['AD_OPEN_PROFILE_CLUBS']; ?></option>
                    </select>
                </td>
            </tr>
        </table>
    ...
    <div id="greets">
        ...
        <h3><?php echo $_LANG['FROM_ATO']; ?></h3>
        <input type="text" style="width:800px;" name="greetmsg_title" value="<?=$cfg['greetmsg_title']?>" placeholder="<?php echo $_LANG['FROM_ATO_TITLE']; ?>"/><br/>
        <textarea name="greetmsg_ato" style="height:200px; width:800px;"><?=$cfg['greetmsg_ato']?></textarea>
    </div>
	 ...
	 <div id="armedlist">
        <table width="661" border="0" cellpadding="10" cellspacing="0" class="proptable">
            <tr>
                <td width="308"><strong>Редагування списку:</strong></td>
