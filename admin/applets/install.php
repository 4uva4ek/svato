...
// ============================================================================== //
    ...
    if ($do == 'install_plugin'){
        ...
        if (!$error && $plugin->install()) {
            cmsCore::redirect('/admin/index.php?view=install&do=finish_plugin&id='.$plugin_id.'&task=install');
        }
...
// ============================================================================== //
    ...
    if ($do == 'upgrade_plugin'){
        ...
        if (!$error && $plugin->upgrade()) {
            cmsCore::redirect('/admin/index.php?view=install&do=finish_plugin&id='.$plugin_id.'&task=upgrade');
        }
...
// ============================================================================== //
    ...
    if ($do == 'remove_plugin'){
        ...
        cmsCore::redirect('/admin/index.php?view=install&do=finish_plugin&id='.$plugin_id.'&task=remove');
...
// ============================================================================== //
    ...
    if ($do == 'finish_plugin'){
        ...
        cmsCore::redirect('/admin/index.php?view=plugins&installed='.$plugin_id.'&task='.$task);
