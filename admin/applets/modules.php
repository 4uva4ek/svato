...
//============================================================================//
    ...
    if ($do == 'list'){
		...
		cpListTable('cms_modules', $fields, $actions, '', 'position, ordering ASC');
                ...
                <td width="300" valign="top" style="background:#ECECEC;">
                    ...
                    <div id="grp">
                        ...
                        <div style="margin-top:13px">
                            <strong><?php echo $_LANG['AD_WHERE_MODULE_VIEW'];?></strong>
                        </div>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
                            <tr>
                                ...
                                <td align="center" width="50"><strong><?php echo $_LANG['AD_POSITION'];?></strong></td>
                            </tr>
