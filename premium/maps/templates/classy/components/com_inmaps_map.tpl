...
<div id="map_wrapper">
    ...
    <div id="inmaps_map_filter" {if !$cfg.map_filter || $root_cat.id!=1}style="display:none"{/if}>
        ...
        <div class="sel_all">
            <a href="javascript:" onclick="$('#filter_form input[type=checkbox]').attr('checked', 'checked');getMarkers()">{$LANG.MAPS_SELECT_ALL}</a> | <a href="javascript:" onclick="$('#filter_form li ul').show()">{$LANG.MAPS_EXPAND}</a>
        </div>
