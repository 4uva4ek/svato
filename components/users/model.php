...
/* ==================================================================================================== */
	public function getUsers($is_online = false){
        ...
        $sql = "SELECT
				...
				p.gender as gender,
				p.residence, p.education, p.kinscontacts, p.phones, p.armedgroup, p.otharmedgroup, p.atospecialty, p.preatospecialty, p.atohelped, p.atohelping
                FROM cms_users u
    ...
    public function getUsersAtoClubs()  {


        $sql = "SELECT u.*, u.logdate as flogdate, u.status as microstatus, p.*
                FROM ato_users u
                INNER JOIN ato_user_profiles p ON p.user_id = u.id
                WHERE u.group_id=11 AND u.is_locked = 0 AND u.is_deleted = 0 AND u.id IN (SELECT user_id FROM ato_user_clubs)
...
/////////////////// участники пока еще не в группах ато
...
/* ==================================================================================================== */
    ...
    public function getUser($login){
		...
		$sql = "SELECT
				...
				p.residence, p.education, p.kinscontacts, p.phones, p.armedgroup, p.otharmedgroup, p.atospecialty, p.preatospecialty, p.atohelped, p.atohelping, p.atohelpedother, p.atohelpingother,
				g.title as grp,
