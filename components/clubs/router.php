<?php
    ...
    function routes_clubs(){
        ...
        $routes[] = array(
		     ...
		     $routes[] = array(
                            '_uri'  => '/^clubs\/([0-9]+)\/problem.html$/i',
                            'do'    => 'problem_view',
                            1       => 'id'
                         );
	        
			$routes[] = array(
                            '_uri'  => '/^clubs\/([0-9]+)\/edit\/problem.html$/i',
                            'do'    => 'problem_edit',
                            1       => 'id'
                         );		
           ...
           $routes[] = array(
                            '_uri'  => '/^clubs\/([0-9]+)\/needs.html$/i',
                            'do'    => 'needs_view',
                            1       => 'id'
                         );
	        
			$routes[] = array(
                            '_uri'  => '/^clubs\/([0-9]+)\/edit\/needs.html$/i',
                            'do'    => 'needs_edit',
                            1       => 'id'
                         );	
			 ...
			 $routes[] = array(
                            '_uri'  => '/^clubs\/([0-9]+)\/propos.html$/i',
                            'do'    => 'propos_view',
                            1       => 'id'
                         );
	        
			$routes[] = array(
                            '_uri'  => '/^clubs\/([0-9]+)\/edit\/propos.html$/i',
                            'do'    => 'propos_edit',
                            1       => 'id'
                         );	
			 ...
			 $routes[] = array(
                            '_uri'  => '/^clubs\/([0-9]+)\/volhelp.html$/i',
                            'do'    => 'volhelp_view',
                            1       => 'id'
                         );
	        
			$routes[] = array(
                            '_uri'  => '/^clubs\/([0-9]+)\/edit\/volhelp.html$/i',
                            'do'    => 'volhelp_edit',
                            1       => 'id'
                         );	
		   ...
		   $routes[] = array(
                            '_uri'  => '/^clubs\/([0-9]+)\/vote_to\-([0-9]+)\/vote_from\-([0-9]+)$/i',
                            'do'    => 'voteforjoin',
							1       => 'id',
                            2       => 'prem_id',
                            3       => 'from_id'
