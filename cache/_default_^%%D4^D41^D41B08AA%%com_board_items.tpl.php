<?php /* Smarty version 2.6.28, created on 2015-07-27 15:34:42
         compiled from com_board_items.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'com_board_items.tpl', 16, false),array('modifier', 'strip_tags', 'com_board_items.tpl', 31, false),array('modifier', 'truncate', 'com_board_items.tpl', 31, false),array('function', 'profile_url', 'com_board_items.tpl', 47, false),array('function', 'math', 'com_board_items.tpl', 60, false),)), $this); ?>
...
"/>
							...
							<td valign="top">
                                ...
                                <div class="bd_moderate_link">
                                    <a href="/board/edit<?php echo $this->_tpl_vars['con']['id']; ?>
.html"><?php echo $this->_tpl_vars['LANG']['EDIT']; ?>
</a> | 
                                    <a href="/board/delete<?php echo $this->_tpl_vars['con']['id']; ?>
...
"><?php echo $this->_tpl_vars['con']['title']; ?>
								...
								<div class="bd_text">
                                    <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['con']['content'])) ? $this->_run_mod_handler('strip_tags', true, $_tmp) : smarty_modifier_strip_tags($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 250) : smarty_modifier_truncate($_tmp, 250)); ?>
