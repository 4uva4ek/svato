<?php /* Smarty version 2.6.28, created on 2015-10-13 15:44:34
         compiled from com_users_view_preato.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'com_users_view_preato.tpl', 23, false),array('function', 'city_input', 'com_users_view_preato.tpl', 27, false),array('function', 'profile_url', 'com_users_view_preato.tpl', 66, false),)), $this); ?>
...
<?php endif; ?>
  <div class="users_list_buttons">
    <div class="button"><a rel=”nofollow” href="/users/ato_members/list">Підтверджені часники АТО</a></div>
    <div class="button selected"><a rel=”nofollow” href="/users/preato_members/list">Нові часники АТО</a></div>
...
" /></a></div></td>
        <td valign="top">
          ...
          <div class="status">
		  <?php if ($this->_tpl_vars['usr']['group_alias'] == 'atos'): ?> <sup>учасник АТО</sup> <?php endif; ?> <?php if ($this->_tpl_vars['usr']['group_alias'] == 'volotners'): ?> <sup>волонтер</sup> <?php endif; ?>
