...
smarty_core_load_plugins(array('plugins' => array(array('function', 'math', 'com_board_cats.tpl', 27, false),)), $this); ?>
<?php if ($this->_tpl_vars['category']['is_can_add'] || $this->_tpl_vars['root_id'] == $this->_tpl_vars['category']['id']): ?>
<div class="float_bar">
	<table cellpadding="2" cellspacing="0">
		<tr><td><img src="/components/board/images/add.gif" border="0"/></td>
		<td><a href="/board/<?php if ($this->_tpl_vars['root_id'] != $this->_tpl_vars['category']['id']): ?><?php echo $this->_tpl_vars['category']['id']; ?>
...
<h1 class="con_heading"><?php echo $this->_tpl_vars['pagetitle']; ?>
 <a href="/rss/board/<?php if ($this->_tpl_vars['root_id'] == $this->_tpl_vars['category']['id']): ?>all<?php else: ?><?php echo $this->_tpl_vars['category']['id']; ?>
...
<p class="usr_photos_notice"><?php echo $this->_tpl_vars['category']['description']; ?>
</p>
<?php endif; ?>