<?php /* Smarty version 2.6.28, created on 2015-05-19 13:07:02
         compiled from vol_user_profile.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'vol_user_profile.tpl', 8, false),array('modifier', 'spellcount', 'vol_user_profile.tpl', 146, false),array('modifier', 'NoSpam', 'vol_user_profile.tpl', 262, false),array('modifier', 'nl2br', 'vol_user_profile.tpl', 271, false),array('function', 'template', 'vol_user_profile.tpl', 50, false),array('function', 'profile_url', 'vol_user_profile.tpl', 177, false),array('function', 'math', 'vol_user_profile.tpl', 183, false),array('function', 'add_js', 'vol_user_profile.tpl', 259, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['usr']['city']; ?>
						...
						<?php if ($this->_tpl_vars['usr']['residence']): ?><div class="field"><div class="title"><?php echo $this->_tpl_vars['LANG']['RESIDENCE']; ?>
:</div><div class="value"><?php echo $this->_tpl_vars['usr']['residence']; ?>
</div></div><?php endif; ?>

					
						<?php if ($this->_tpl_vars['usr']['phones']): ?><div class="field"><div class="title"><?php echo $this->_tpl_vars['LANG']['PHONES']; ?>
...
" class="email"><?php echo $this->_tpl_vars['usr']['email']; ?>
							...
							<?php if ($this->_tpl_vars['usr']['education']): ?><div class="field"><div class="title"><?php echo $this->_tpl_vars['LANG']['EDUCATION']; ?>
:</div><div class="value"><?php echo ((is_array($_tmp=$this->_tpl_vars['usr']['education'])) ? $this->_run_mod_handler('nl2br', true, $_tmp) : smarty_modifier_nl2br($_tmp)); ?>
</div></div><?php endif; ?>
							
							<?php if ($this->_tpl_vars['usr']['atohelped']): ?><div class="field"><div class="title"><?php echo $this->_tpl_vars['LANG']['ATOHELPED']; ?>
:</div><div class="value"><?php echo $this->_tpl_vars['usr']['atohelped']; ?>
</div></div><?php endif; ?>
							<?php if ($this->_tpl_vars['usr']['atohelpedother']): ?><div class="field"><div class="title"><?php echo $this->_tpl_vars['LANG']['ATOHELPEDOTHER']; ?>
:</div><div class="value"><?php echo $this->_tpl_vars['usr']['atohelpedother']; ?>
</div></div><?php endif; ?>
							<?php if ($this->_tpl_vars['usr']['atohelping']): ?><div class="field"><div class="title"><?php echo $this->_tpl_vars['LANG']['ATOHELPING']; ?>
:</div><div class="value"><?php echo $this->_tpl_vars['usr']['atohelping']; ?>
</div></div><?php endif; ?>
							<?php if ($this->_tpl_vars['usr']['atohelpingother']): ?><div class="field"><div class="title"><?php echo $this->_tpl_vars['LANG']['ATOHELPINGOTHER']; ?>
:</div><div class="value"><?php echo $this->_tpl_vars['usr']['atohelpingother']; ?>
</div></div><?php endif; ?>
...
?>
					<?php if ($this->_tpl_vars['plugin']['name'] !== 'p_userbattleways'): ?>
